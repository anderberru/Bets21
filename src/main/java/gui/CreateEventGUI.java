...
public class CreateEventGUI extends JFrame {
	...
	private void jbInit(Vector<domain.Event> v) throws Exception {
		...
		jLabelDescription.setBounds(new Rectangle(275, 50, 75, 20));
		jTextFieldDescription.setBounds(new Rectangle(369, 50, 200, 20));
		...
		try {
			...
			jLabelMsg.setText("");
					...
					if (!description.isBlank()) {
						facade.createEvent(description, date);
						jLabelMsg.setText(ResourceBundle.getBundle("Etiquetas").getString("EventCreated"));
					} 
					else {
						jLabelMsg.setText(ResourceBundle.getBundle("Etiquetas").getString("IncorrectDataNull"));
					}

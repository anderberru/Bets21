...
public class AddBetBLBMTest {
	...
	public void test1() {
			try {
				...
				Question q=sut.createQuestion(mockedEvent, queryText, betMinimum, oneDate);
	...
	public void test3() {
		try {
			...
			//invoke System Under Test (sut) 
			Question q=sut.createQuestion(null, queryText, betMinimum, oneDate);
	...
	public void test7() {
		try {
			...
			//invoke System Under Test (sut) 
			sut.createQuestion(mockedEvent, queryText, betMinimum, oneDate);
